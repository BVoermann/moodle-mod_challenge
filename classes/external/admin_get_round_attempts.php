...
class admin_get_round_attempts extends external_api {
    ...
    public static function request_returns() {
        return new external_multiple_structure(attempt_dto::get_read_structure());
    }

    /**
     * Get all attempts of a round.
     *
    ...
    public static function request($coursemoduleid, $roundid) {
        ...
        foreach ($attempts as $attempt) {
            $attempt_dto = new attempt_dto($attempt, $ctx);
            $result[] = $attempt_dto->export($renderer);
        }
        return $result;
    }
}
