...
class admin_get_round_questions extends external_api {
    ...
    public static function request_returns() {
        return new external_multiple_structure(question_dto::get_read_structure());
    }

    /**
     * Get all questions of a round.
     *
    ...
    public static function request($coursemoduleid, $roundid) {
        ...
        $questions = $round->get_match_questions();
        ...
        foreach ($questions as $question) {
            $question_dto = new question_dto($question, $game, $ctx);
            $result[] = $question_dto->export($renderer);
        }
        return $result;
    }
}
